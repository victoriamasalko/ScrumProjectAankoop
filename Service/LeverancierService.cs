...
namespace Service
{
    public class LeverancierService(ILeverancierRepository leverancierRepository)
    {
        ...
        public async Task<Leverancier?> GetLeverancierByIdAsync(int id)
            => await leverancierRepository.GetLeverancierByIdAsync(id);
        
        public async Task<IEnumerable<Leverancier>> GetLeveranciersAsync() 
            => await leverancierRepository.GetLeveranciersAsync();
        
        public async Task<Leverancier> UpdateLeverancierAsync(Leverancier leverancier)
            => await leverancierRepository.UpdateLeverancierAsync(leverancier);
    }
}
